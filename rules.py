...
def infer_job_titles_from_position_name(position_name: str, allowed_job_titles: list[str]) -> list[str]:
    ...
    rules = [
        ...
        (["machine learning", "ml engineer", "deep learning", "computer vision", "nlp"], ["Machine Learning Engineer", "AI Engineer"]),
        (["ai engineer", "artificial intelligence", "genai", "llm engineer", "generative ai"], ["AI Engineer", "Machine Learning Engineer"]),
        (["data engineer", "big data", "etl"], ["Data Engineer", "Big Data Engineer"]),
        (["data scientist", "data science"], ["Data Scientist"]),
        (["devops", "site reliability", "sre", "platform engineer"], ["DevOps Engineer", "Site Reliability Engineer"]),
        (["cloud engineer", "infrastructure engineer"], ["Cloud Engineer", "DevOps Engineer"]),
        (["embedded", "firmware"], ["Embedded Developer"]),
        (["security engineer", "penetration", "appsec", "cyber"], ["Security Engineer"]),
        (["mobile engineer", "ios developer", "android developer", "mobile developer"], ["Mobile Developer"]),
        (["qa engineer", "test engineer", "automation tester", "sdet", "quality engineer"], ["QA Automation Tester", "Developer in Test"]),
        (["front end", "frontend", "front-end", "ui engineer"], ["Front End", "Full Stack"]),
        (["back end", "backend", "back-end"], ["Back End", "Full Stack"]),
        (["full stack", "fullstack", "full-stack"], ["Full Stack", "Back End"]),
        (["software engineer", "software developer", "software dev", "product engineer", "graduate software", "solutions engineer"], ["Full Stack", "Back End", "Solutions Engineer"]),
